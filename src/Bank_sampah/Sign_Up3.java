...
public class Sign_Up3 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel3.add(jLabel_tmpSignUp, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 39, 340, -1));

        jLabel_tmpFullName.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jLabel_tmpFullName.setForeground(new java.awt.Color(255, 255, 255));
        jLabel_tmpFullName.setText("Full Name");
        jPanel3.add(jLabel_tmpFullName, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 130, -1, 20));

        jTextField_FullName.setBackground(new java.awt.Color(51, 102, 0));
        jTextField_FullName.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        ...
        jPanel3.add(jTextField_FullName, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 150, 190, 30));
        ...
        jPanel3.add(jLabel_iconFullName, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 150, 30, 30));

        jSeparator_FullName.setForeground(new java.awt.Color(255, 255, 255));
        jPanel3.add(jSeparator_FullName, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 180, 190, 10));

        jLabel_tmpUsername.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jLabel_tmpUsername.setForeground(new java.awt.Color(255, 255, 255));
        jLabel_tmpUsername.setText("Username");
        jPanel3.add(jLabel_tmpUsername, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 190, -1, 20));
        ...
        jPanel3.add(jTextField_Username, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 210, 190, 30));
        ...
        jPanel3.add(jLabel_iconUsername, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 210, 30, 30));

        jSeparator_Username.setForeground(new java.awt.Color(255, 255, 255));
        jPanel3.add(jSeparator_Username, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 240, 190, 10));

        jLabel_tmpPassword.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jLabel_tmpPassword.setForeground(new java.awt.Color(255, 255, 255));
        jLabel_tmpPassword.setText("Password");
        jPanel3.add(jLabel_tmpPassword, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 250, -1, 20));
        ...
        jPanel3.add(jPasswordField_SignUp, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 270, 190, 30));
        ...
        jPanel3.add(jLabel_iconPassword, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 270, 30, 30));

        jSeparator_PassSignUp.setForeground(new java.awt.Color(255, 255, 255));
        jPanel3.add(jSeparator_PassSignUp, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 300, 190, 10));

        jLabel_tmpConfirmPass.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jLabel_tmpConfirmPass.setForeground(new java.awt.Color(255, 255, 255));
        jLabel_tmpConfirmPass.setText("Confirm Password");
        jPanel3.add(jLabel_tmpConfirmPass, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 310, -1, 20));
        ...
        jPanel3.add(jPasswordField_Confirm, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 330, 190, 30));
        ...
        jPanel3.add(jLabel_iconConfirmPass, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 330, 30, 30));

        jSeparator_ConfirmPass.setForeground(new java.awt.Color(255, 255, 255));
        jPanel3.add(jSeparator_ConfirmPass, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 360, 190, 10));
        ...
        jPanel3.add(jButton_SignUp, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 420, 240, 40));
        ...
        jPanel3.add(jLabel_toHome, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 490, 240, -1));
